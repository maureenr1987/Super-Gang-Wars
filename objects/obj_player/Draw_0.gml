...
if (global.debug) && (current_hp >= 0){
	...
	draw_set_alpha(0.7);
	draw_line_color(x+lengthdir_x(look_dist*0.75,facepoint),y+lengthdir_y(look_dist*0.75,facepoint),x+lengthdir_x(look_dist,facepoint),y+lengthdir_y(look_dist,facepoint),c_white,c_white)
	draw_set_alpha(1);
